...
export const POIS: Record<string, Poi[]> = {
  "costa-lucidiana": [
    ...
    { name: "Lago Mooren", type: "natural", blurb: "Gran lago que nutre la costa y sus asentamientos.", x: 48, y: 74 },
  ...
  "sierras-alabastro": [
    ...
    { name: "Vega del Mooren", type: "natural", blurb: "Vega fértil a lo largo del río Anclado.", x: 40, y: 74 },
  ],
  "llanuras-divisorias": [
  ...
  "montanas-torrerrisco": [
    ...
    { name: "Fuerte Daxio", type: "fortaleza", blurb: "Fortaleza militar clave de Tal'Dorei.", x: 30, y: 30 },
  ...
  "montanas-crestormentas": [
    ...
    { name: "Caverna del Axioma", type: "cueva", blurb: "Gruta de secretos arcanos.", x: 70, y: 40 },
    { name: "Garganta Cenicienta", type: "peligro", blurb: "Grieta ligada al advenimiento del Rey Cinéreo.", x: 50, y: 78 },
  ],
  "peninsula-pleabruma": [
    ...
    { name: "Montañas Puntormenta", type: "natural", blurb: "Cumbres tempestuosas y tribus orroyen.", x: 62, y: 30 },
  ],
  "expansion-verdante": [
  ...
  "litoral-filofulgor": [
    ...
    { name: "Bahía de las Dagas", type: "natural", blurb: "Una ensenada abierta y amplia al sur de la capital, resguardada del oleaje por la costa recortada. Entre sus calas escondidas se puede fondear sin que nadie te vea desde tierra firme.", x: 45, y: 40 },
    { name: "Puesto Esmeralda", type: "fortaleza", blurb: "Enclave fronterizo en la costa agreste.", x: 55, y: 58 },
    { name: "Cavernas Cienocristal", type: "cueva", blurb: "Grutas de cristal fangoso y ecos antiguos.", x: 30, y: 55 },
