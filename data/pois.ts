...
export const POIS: Record<string, Poi[]> = {
  ...
  "montanas-torrerrisco": [
    ...
    { name: "Wittebak", type: "ciudad", blurb: "Asentamiento aferrado a una repisa en pleno macizo de Torrerrisco; vive del paso de mineros y viajeros que necesitan techo antes de seguir subiendo.", x: 51, y: 57 },
    { name: "Valle Gris", type: "natural", blurb: "Valle boscoso encajado entre dos picos, casi siempre en sombra por la altura de las laderas; dicen que allí el sol solo visita al mediodía.", x: 66, y: 48 },
    { name: "Colinas Umbra", type: "natural", blurb: "Lomas que se alzan sobre la Aldea de Jorenn; los mineros bajan de ellas con más preguntas que mineral cuando algo se remueve bajo la superficie.", x: 74, y: 70 },
    { name: "Los Campos del Nunca", type: "peligro", blurb: "Yermo helado que cierra el macizo por el norte; ningún mapa marca un camino seguro y quien se pierde allí rara vez vuelve a hallarse.", x: 70, y: 4 },
    { name: "Bosque del Cerco Oeste", type: "natural", blurb: "Franja de bosque en la vertiente occidental de la cordillera, refugio de cazadores furtivos que prefieren no cruzarse con las patrullas de Fuerte Daxio.", x: 29, y: 45 },
    { name: "Bosque Torian", type: "natural", blurb: "Bosque que se extiende al pie sur de la cordillera de Torrerrisco, tierra de paso entre el macizo y las tierras bajas del sureste.", x: 33, y: 96 },
    { name: "Cabeza de la Serpiente", type: "natural", blurb: "Espolón rocoso cuya silueta recuerda, vista desde lejos, a una serpiente alzada; sirve de referencia a quien se orienta por la cordillera.", x: 36, y: 89 },
    { name: "Bosque de Wildwood", type: "natural", blurb: "La mancha boscosa que cubre el sureste del macizo, más domesticada que el resto de la cordillera; aun así nadie se adentra sin avisar a alguien.", x: 55, y: 76 },
  ],
