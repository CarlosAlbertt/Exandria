...
export const REGIONS: Region[] = [
  { slug: "costa-lucidiana", name: "Costa Lucidiana", capital: "Stilben", accent: "var(--color-arcane)", feature: "Capital y corazón político", blurb: "El litoral más poblado del continente. Aquí se alza Emon, sede del Consejo de Tal'Dorei, junto a puertos prósperos y campos fértiles.", image: "/maps/regions/costa-lucidiana.jpg", map: { x: 52, y: 38 } },
  { slug: "sierras-alabastro", name: "Sierras de Alabastro", capital: "Piedrablanca", accent: "var(--color-bronze)", feature: "Mesetas y rutas comerciales", blurb: "Colinas pálidas y pasos de montaña que conectan el oeste con el interior. Tierra de caravanas, minas y la ciudad de Westruun.", image: "/maps/regions/sierras-alabastro.jpg", map: { x: 50, y: 36 } },
  ...
  { slug: "peninsula-pleabruma", name: "Península de Pleabruma", capital: "Byroden", accent: "var(--color-arcane-deep)", feature: "Brumas y secretos", blurb: "Una península envuelta en niebla y leyenda, con puertos sombríos donde florece todo lo que prefiere no ser visto.", image: "/maps/regions/peninsula-pleabruma.jpg", map: { x: 48, y: 55 } },
  ...
  { slug: "litoral-filofulgor", name: "Litoral de Filofulgor", capital: "Emon", accent: "var(--color-ember)", feature: "Costa oriental ardiente", blurb: "La costa más lejana y agreste, de acantilados cortantes y asentamientos fronterizos que miran al mar abierto.", image: "/maps/regions/litoral-filofulgor.jpg", map: { x: 44, y: 50 } },
];
