...
export type CharClass = {
  ...
  skillList: string[];
  // (Aquí vivía `oficios: string[]`, la lista de 2–4 oficios que cada clase
  //  podía aprender. Se retiró el 2026-08-06: los SIETE están abiertos a todo
  //  el mundo y lo único que limita es el CUPO —uno a nivel 1 y otro a nivel 7,
  //  `OFICIO_LEVELS` en `data/leveling.ts`—. Se borra en vez de dejarlo sin
  //  leer: el repo ya arrastra un `skillChoices` muerto en los 13 `classdata`,
  //  y dos listas donde una no la mira nadie es lo que confunde en la siguiente
  //  sesión. La fuente única es ahora `rules.OFICIOS`.)
