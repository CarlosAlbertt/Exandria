...
export const WILDEMOUNT_POIS: Record<string, Poi[]> = {
  ...
  "yermos-grisaceos": [
    ...
    { name: "Molaesmyr", type: "ruina", blurb: "Ruinas de una antigua ciudad élfica, tragadas por el Savalirwood junto al Boreal Omen River; desde Uthodurn llegan expediciones a buscar reliquias entre sus torres caídas.", x: 37, y: 69 },
    { name: "Savalirwood", type: "natural", blurb: "Bosque corrompido que cubre el sur de los Yermos Grisáceos, entre Molaesmyr y Shadycreek Run; niebla espesa y vegetación enferma lo cubren entero.", x: 30, y: 78 },
    { name: "Arboleda Floreciente", type: "natural", blurb: "Claro apartado en el Savalirwood, a pocas millas al noroeste de Shadycreek Run; un pequeño templo y un cementerio se ocultan entre sus árboles.", x: 39, y: 88 },
    { name: "Brecha de Quannaa", type: "natural", blurb: "Paso estrecho entre los montes al sur de Shadycreek Run, en la ruta que baja hacia el Valle del Tuétano.", x: 30, y: 97 },
    { name: "Tundra Crystalsands", type: "natural", blurb: "Llanura helada que ocupa el noroeste de la carta, entre la Aldea Palebank y los primeros contrafuertes de los Alpes Flotket.", x: 38, y: 27 },
    { name: "Kravaraad", type: "natural", blurb: "Cumbre en el corazón de los Alpes Flotket, justo al norte de Uthodurn; el Santuario de Cinderrest se abre en su ladera oriental.", x: 55, y: 36 },
    { name: "Santuario de Cinderrest", type: "cueva", blurb: "Cavidad excavada en la ladera oriental de Kravaraad, con una poza de lava en su interior; forja y lugar de culto a la vez.", x: 56, y: 41 },
    { name: "Alpes Flotket", type: "natural", blurb: "Cordillera nevada que domina el centro de los Yermos Grisáceos, con picos de hasta 6.000 pies y cuevas talladas en sus laderas.", x: 71, y: 36 },
    { name: "Mythburrow", type: "cueva", blurb: "Cueva helada en la ladera oriental de los Alpes Flotket, con la entrada cubierta de hielo y carámbanos retorcidos.", x: 86, y: 24 },
    { name: "Uraliss", type: "ciudad", blurb: "Pequeño asentamiento junto al Boreal Omen River, al sureste de Uthodurn y camino de las Llanuras Rime.", x: 62, y: 52 },
    { name: "Lago Ivory", type: "natural", blurb: "Lago alargado al pie de los Alpes Flotket, alimentado por el Boreal Omen River antes de que este se pierda en las Llanuras Rime.", x: 54, y: 57 },
    { name: "Llanuras Rime", type: "natural", blurb: "Estepa fría al este de Uthodurn, entre el Lago Ivory y Boroftkrab; apenas unos bosquecillos rompen la llanura helada.", x: 66, y: 61 },
    { name: "Boroftkrab", type: "ciudad", blurb: "Asentamiento en las estribaciones montañosas del sureste de los Yermos Grisáceos, cerca del límite con el Barranco Esmeralda de Xhorhas.", x: 57, y: 79 },
    { name: "Taergoss", type: "natural", blurb: "Isla montañosa y aislada en las Profundidades Gélidas, al noroeste de la carta, frente a la costa de la Tundra Crystalsands.", x: 7, y: 30 },
  ],
  "costa-del-serrallo": [
    ...
    { name: "Bosque Vzedaweald", type: "natural", blurb: "Masa boscosa en el extremo norte de la Costa del Serrallo, sobre la península de Vzedali, con montañas altas cerrando el paisaje por el interior.", x: 27, y: 6 },
    { name: "Península Vzedali", type: "natural", blurb: "Lengua de tierra boscosa al noroeste de la Costa del Serrallo; Palma Flora se asienta en su misma orilla.", x: 26, y: 25 },
    { name: "Palma Flora", type: "ciudad", blurb: "Población costera en la punta de la península de Vzedali, frente a las islas dispersas que salpican esta parte del golfo.", x: 32, y: 25 },
    { name: "Isla Bisaft", type: "natural", blurb: "Isla alargada y boscosa mar adentro, al oeste de la península de Vzedali; la más occidental de las islas de este tramo de costa.", x: 8, y: 28 },
    { name: "Archipiélago Gravid", type: "natural", blurb: "Cadena de islotes boscosos al suroeste de Isla Bisaft, camino del archipiélago de Brokenbank.", x: 9, y: 48 },
    { name: "Arrecife del Suspiro de la Madre", type: "peligro", blurb: "Bajío extenso en aguas abiertas frente a Puerto Damali; ningún islote lo señala, solo la marca en las cartas de navegación.", x: 47, y: 16 },
    { name: "Islas Gemelas", type: "natural", blurb: "Dos islotes boscosos casi idénticos en mar abierto, entre Puerto Damali y Puerto Zoon.", x: 46, y: 27 },
    { name: "Bosque Plumgroves", type: "natural", blurb: "Espesura que cubre las estribaciones bajas de las Montañas Cyrios, al norte de Feolinn.", x: 60, y: 14 },
    { name: "Bosque Fin de Cyrios", type: "natural", blurb: "Bosque que se extiende donde las Montañas Cyrios pierden altura, junto al paso de la Puerta de Wuyun.", x: 72, y: 22 },
    { name: "Puerta de Wuyun", type: "fortaleza", blurb: "Fortaleza que vigila el único paso entre las Montañas Cyrios y los Picos Ashkeeper; el camino hacia Nicodranas cruza bajo sus muros.", x: 85, y: 20 },
    { name: "Brokenbank", type: "ciudad", blurb: "Pequeño asentamiento sobre la isla del mismo nombre, en mar abierto al suroeste de la península de Vzedali.", x: 26, y: 52 },
    { name: "Isla Brokenbank", type: "natural", blurb: "Cadena de islotes que da cobijo al asentamiento de Brokenbank, en pleno golfo.", x: 24, y: 53 },
    { name: "Cayo Vide", type: "natural", blurb: "Islote diminuto y solitario en aguas abiertas, al este del Archipiélago Gravid.", x: 31, y: 61 },
    { name: "Arrecife de la Hilera Profunda", type: "peligro", blurb: "Bajío extenso en las aguas del suroeste, sin isla ni marca alguna que lo señale a simple vista.", x: 15, y: 79 },
    { name: "Bwualli", type: "natural", blurb: "Isla montañosa y boscosa en el extremo suroeste de la Costa del Serrallo, unida por un istmo estrecho a Itaa.", x: 26, y: 81 },
    { name: "Itaa", type: "natural", blurb: "Isla escarpada al sur de Bwualli, con la que forma una única masa de tierra alargada.", x: 23, y: 93 },
    { name: "Arrecife de la Puerta Sur", type: "peligro", blurb: "Bajío que cierra por el sur las aguas de Bwualli e Itaa, en el límite meridional de la carta.", x: 29, y: 95 },
    { name: "Vo", type: "ciudad", blurb: "El único asentamiento de la isla de Rumblecusp, en mar abierto al sureste de la costa; un puñado de casas junto a la playa.", x: 60, y: 77 },
    { name: "Lago Raska", type: "natural", blurb: "Lago junto a la costa, al pie de la selva Quataska y cerca de Nicodranas.", x: 78, y: 57 },
    { name: "Selva Quataska", type: "natural", blurb: "Gran extensión de selva que cubre el interior al este de Nicodranas, hasta el pie de los Picos Ashkeeper.", x: 87, y: 57 },
    { name: "Arrecife Garra de Tinta", type: "peligro", blurb: "Bajío en aguas abiertas al sur de la selva Quataska, camino de Urukaxl.", x: 78, y: 88 },
    { name: "Urukaxl", type: "natural", blurb: "Isla pequeña y aislada en el extremo sur de la carta, la última tierra visible antes de mar abierto.", x: 77, y: 97 },
  ],
  "costa-del-serrallo-norte": [
    ...
    { name: "Sepesca", type: "ruina", blurb: "Templo en ruinas oculto en un claro entre el Bosque de Lushgut y el de Doralle; un camino olvidado todavía lo une a Gwardan.", x: 32, y: 54 },
    { name: "Everplume", type: "peligro", blurb: "Volcán submarino en pleno Arrecife Tórrido, al suroeste de la costa; una columna de humo marca su posición sobre el agua.", x: 24, y: 84 },
    { name: "Arrecife Tórrido", type: "peligro", blurb: "Bajío extenso en aguas abiertas al suroeste de la Costa del Serrallo Norte, con el volcán de Everplume asomando en su centro.", x: 33, y: 79 },
    { name: "Bosque de Doralle", type: "natural", blurb: "Masa boscosa en el centro de la Costa del Serrallo Norte, entre el Bosque de Lushgut y las estribaciones de las Montañas Cyrios.", x: 43, y: 40 },
    { name: "Bosque de Lushgut", type: "natural", blurb: "Bosque que cubre el extremo occidental de la carta, entre los Acantilados de Stonecage y el Bosque de Doralle.", x: 20, y: 23 },
    { name: "Arboleda Pálida", type: "natural", blurb: "Valle boscoso aislado en las alturas de las Montañas Cyrios, en el tramo norte de la cordillera.", x: 49, y: 26 },
    { name: "Estanque de Festerwill", type: "natural", blurb: "Poza de montaña en pleno macizo de las Montañas Cyrios, origen del río que baja hacia el Lago Copia.", x: 66, y: 41 },
    { name: "Lago Copia", type: "natural", blurb: "Lago alimentado por el Estanque de Festerwill, al borde de la Selva de Copia y camino de Tussoa.", x: 76, y: 69 },
    { name: "Selva de Copia", type: "natural", blurb: "Espesura al pie de las Montañas Cyrios, entre el Lago Copia y el camino que baja hacia Tussoa.", x: 68, y: 76 },
    { name: "Paso de Siltbasin", type: "natural", blurb: "Paso entre las Montañas Cyrios que enlaza Gwardan con el Lago Copia; un camino y un pequeño lago se aprietan entre los picos.", x: 52, y: 74 },
    { name: "Acantilados de Stonecage", type: "natural", blurb: "Acantilados escarpados en la punta noroeste de la carta, donde el Bosque de Lushgut se asoma al mar.", x: 10, y: 5 },
    { name: "Orilla Baldía", type: "natural", blurb: "Litoral desnudo en el extremo norte de la carta, frente al macizo de las Montañas Cyrios.", x: 48, y: 9 },
    { name: "Marjal de Othemoor", type: "natural", blurb: "Marisma que rodea Othe, encajada entre las Montañas Cyrios y el mar, en la esquina sureste de la carta.", x: 90, y: 95 },
  ],
  "eiselcross": [
    ...
    { name: "Biessel", type: "natural", blurb: "Isla montañosa en el extremo noroeste del archipiélago de Eiselcross, la más aislada de las tierras heladas que la rodean.", x: 9, y: 15 },
    { name: "Gelier", type: "natural", blurb: "Isla cubierta casi por completo de montañas nevadas, al sur de Biessel; en su costa se asientan Vurmas y la Tumba del Gusano.", x: 19, y: 32 },
    { name: "Vurmas", type: "ciudad", blurb: "Enclave en la costa occidental de la isla de Gelier, frente al mar abierto que separa el archipiélago del resto de Wildemount.", x: 8, y: 37 },
    { name: "Tumba del Gusano", type: "ruina", blurb: "Ruina señalada en las estribaciones meridionales de Gelier, entre los picos que cierran la isla por el sur.", x: 23, y: 43 },
    { name: "Schneescel", type: "natural", blurb: "Islote rocoso al sureste de Gelier, con afloramientos de piedra desnuda asomando entre el hielo del archipiélago.", x: 25, y: 58 },
    { name: "Frostbogen", type: "natural", blurb: "Lengua de tierra montañosa al sur de Schneescel, la más meridional de las islas menores de Eiselcross.", x: 31, y: 78 },
    { name: "Mutalos", type: "ruina", blurb: "Ruina marcada en las estribaciones norteñas del macizo central de Eiselcross, cerca de donde el hielo se rompe contra el mar.", x: 35, y: 25 },
    { name: "Fortaleza del Jarl Muerto", type: "ruina", blurb: "Ruina fortificada en las montañas del norte de Eiselcross, al este de Mutalos, junto al nacimiento del Río Inferno.", x: 44, y: 27 },
    { name: "Dampfkan", type: "natural", blurb: "Isla montañosa aislada en el extremo nororiental de Eiselcross, separada del resto del archipiélago por mar abierto.", x: 50, y: 13 },
    { name: "Aeor", type: "ruina", blurb: "Ruinas de la ciudad voladora que cayó durante la Calamidad, sepultadas bajo el hielo del macizo central de Eiselcross.", x: 41, y: 43 },
    { name: "Foren", type: "natural", blurb: "Cadena montañosa que ocupa el este del macizo central de Eiselcross, entre Aeor y la costa que mira a Syrinlya.", x: 52, y: 41 },
    { name: "Río Inferno", type: "natural", blurb: "Curso de lava que baja desde las montañas del norte hasta la costa meridional de Eiselcross, marcado en rojo sobre el hielo del mapa.", x: 39, y: 49 },
    { name: "Santuario de Aloravak", type: "campamento", blurb: "Enclave junto al cauce del Río Inferno, en el sur del macizo central de Eiselcross.", x: 42, y: 57 },
    { name: "Syrinlya", type: "ciudad", blurb: "Asentamiento en la costa oriental de Eiselcross, frente al islote de Kaltsel.", x: 65, y: 58 },
    { name: "Kaltsel", type: "natural", blurb: "Islote frente a la costa oriental de Eiselcross, cerca de Syrinlya, en el mar que mira a la Tundra Crystalsands.", x: 70, y: 54 },
    { name: "Balenpost", type: "fortaleza", blurb: "Puesto en la costa meridional de Eiselcross, junto a la desembocadura del Río Inferno.", x: 47, y: 79 },
  ],
  "costa-de-la-plaga": [
