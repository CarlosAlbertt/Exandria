...
export default function Ataques({
  ...
  // (y el conteo por CANTIDAD, que es lo que importa: la hoja fusiona objetos del
  // mismo nombre, así que dos dagas son UNA entrada con qty 2) vive en
  // lib/ataque.ts, con su comprobación.
