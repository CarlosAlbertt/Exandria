...
import TableroPanel from "./TableroPanel";

type Tab = "narracion" | "grupo" | "baul" | "regiones" | "mapa" | "usuarios" | "dados" | "cronica" | "mesa" | "tablero" | "tiempo" | "arte" | "tiendas" | "pnjs";
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="flex justify-center gap-2 mb-8 flex-wrap">
        {([["narracion", "Narración", "fa-feather-pointed"], ["grupo", "Grupo", "fa-users-line"], ["baul", "Baúl", "fa-box-archive"], ["dados", "Dados", "fa-dice-d20"], ["cronica", "Crónica", "fa-book-open"], ["mesa", "Mesa", "fa-chess"], ["tablero", "Tablero", "fa-chess-board"], ["tiempo", "Tiempo", "fa-clock"], ["regiones", "Regiones", "fa-earth-americas"], ["mapa", "Mapa", "fa-map-location-dot"], ["arte", "Arte", "fa-image"], ["tiendas", "Tiendas", "fa-store"], ["pnjs", "PNJs", "fa-comments"], ["usuarios", "Usuarios", "fa-users"]] as const).map(([id, label, icon]) => (
