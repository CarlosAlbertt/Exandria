...
type Tab = "narracion" | "grupo" | "baul" | "regiones" | "mapa" | "usuarios" | "dados";
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="flex justify-center gap-2 mb-8 flex-wrap">
        {([["narracion", "Narración", "fa-feather-pointed"], ["grupo", "Grupo", "fa-users-line"], ["baul", "Baúl", "fa-box-archive"], ["dados", "Dados", "fa-dice-d20"], ["regiones", "Regiones", "fa-earth-americas"], ["mapa", "Mapa", "fa-map-location-dot"], ["usuarios", "Usuarios", "fa-users"]] as const).map(([id, label, icon]) => (
